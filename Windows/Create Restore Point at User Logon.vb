...
Public Class Create_Restore_Point_at_User_Logon
            ...
            Using taskServiceObject As TaskService = New TaskService() ' Creates a new instance of the TaskService.
                ...
                If oldTaskObject IsNot Nothing Then
                    ...
                    If newTask.Validate() Then
                        ...
                        Functions.eventLogFunctions.writeToApplicationLogFile(String.Format("Creating scheduled task ""{0}"" in ""{1}"".", strTaskName, taskFolderObject.Name), EventLogEntryType.Information, False)
    ...
    Private Sub addAtUserLoginTask(Optional delayed As Boolean = False, Optional delayTimeInMinutes As Short = 10)
        ...
        Catch ex As InvalidOperationException
            ...
            Functions.eventLogFunctions.writeToApplicationLogFile("There was an error while validating the task definition settings.", EventLogEntryType.Error, False)
