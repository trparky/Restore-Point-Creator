...
Public Class Mount_Volume_Shadow_Copy
    ...
    Private Sub btnMount_Click(sender As Object, e As EventArgs) Handles btnMount.Click
        ...
        Catch ex As NullReferenceException
            ...
            Functions.eventLogFunctions.writeToApplicationLogFile("Something went wrong, unable to find entry in shadowCopyCache Object.", EventLogEntryType.Error, False)
