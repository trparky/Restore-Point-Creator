...
#If DEBUG Then
            ...
            Public Const shortReleaseCandidateVersion As Short = 1
#Else
    ...
    Namespace webURLs
        ...
        Namespace core
            Module core
                ...
                Public Const strProgramUpdateChecker As String = "www.toms-world.org/download/restorepointcreatorversion.xml"
